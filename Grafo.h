...
private:
    ...
    void sort_arestas(int arestas[][3], int n)
    {
        for (int i = 0; i < n - 1; i++)
        {
            for (int j = 0; j < n - i - 1; j++)
            {
                ...
                {
                    int temp0 = arestas[j][0];
                    int temp1 = arestas[j][1];
                    int temp2 = arestas[j][2];
...
public:
    ...
    {
        int num_arestas = 0;
        int arestas[MAX_EDGES][3]; // Array para armazenar as arestas (origem, destino, peso)
        ...
        for (int i = 1; i <= ordem; i++)
        {
            for (int j = i + 1; j <= ordem; j++)
            {
                ...
                if (peso > 0)
                {
                    arestas[num_arestas][0] = i;
                    arestas[num_arestas][1] = j;
                    arestas[num_arestas][2] = peso;
                    num_arestas++;
                }
            }
        }
        ...
        sort_arestas(arestas, num_arestas);

        // Arrays para representar os conjuntos disjuntos
        int* parent = new int[ordem + 1];
        int* rank = new int[ordem + 1];
        ...
        int resultado[MAX_EDGES][3]; // Armazena as arestas da AGMG
        ...
        for (int i = 0; i < num_arestas; i++)
        {
            ...
            int x = find(parent, origem);
            int y = find(parent, destino);

            if (x != y)
            {
                resultado[e][0] = origem;
                resultado[e][1] = destino;
                resultado[e][2] = peso;
                e++;
        ...
        // Exibe o resultado
        cout << "Arestas da Árvore Geradora Mínima Generalizada:" << endl;
        for (int i = 0; i < e; i++)
        {
            cout << resultado[i][0] << " - " << resultado[i][1] << " : " << resultado[i][2] << endl;
        }
